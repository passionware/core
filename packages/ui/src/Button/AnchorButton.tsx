...
export interface AnchorButtonProps extends ComponentPropsWithoutRef<"a"> {
...
const config = {
  ...
  secondary: {
    ...
    ghost: classNames(
      "text-gray-500 border-gray-300 hover:bg-black/10 active:bg-black/20 aria-expanded:bg-black/20 focus-visible:ring-gray-300",
...
const baseStyles = classNames(
  "font-medium rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 flex flex-row items-center",
...
export const AnchorButton = forwardRef<HTMLAnchorElement, AnchorButtonProps>(
  (
    ...
    return (
      <a className={buttonClass} ref={ref} {...rest}>
        {leftSlot && (
          <span className="shrink-0 flex items-center justify-center">
            {leftSlot}
          </span>
        )}
        {children && <span className="grow flex items-center">{children}</span>}
        {rightSlot && (
          <span className="shrink-0 flex items-center justify-center">
            {rightSlot}
          </span>
